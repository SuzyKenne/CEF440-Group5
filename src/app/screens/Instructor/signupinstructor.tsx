      ...
      <ThemedView style={styles.container}>
        ...
        />
          <ThemedText type="title" style={styles.title}>
            ...
            <Input label ="Confirm password:" onChangeText={()=>{}} placeholder="confirm password"/>
            
        <ThemedText>
            <ThemedText style={styles.button}>
                <CustomButton title="create account" onPress={() => router.push("../screens/signupinstructor.tsx")} />
            </ThemedText>
        </ThemedText>
      </ThemedView>
    );
